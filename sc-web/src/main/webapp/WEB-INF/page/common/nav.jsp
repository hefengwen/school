...
<div class="row clearfix">
  <div class="col-md-12 column" style="background: url('${basePath}/image/logo_school.png') no-repeat;">
    <div class="row clearfix">
    ...
    <div class="row clearfix" style="height: 58px; background-color: #99CCFF;padding: 2px 0;">
      ...
      <div class="col-md-6 column col-md-offset-3" style="height: 54px; background-color: #99CCFF;padding: 2px 0;">
