  ...
  <div class="container">
    ...
    <div class="row clearfix allContent">
      <div class="row clearfix" style="height: 100%;">
        ...
        <div class="content">
          <div class="condition">
            <form id="condition" role="form" action="<c:url value="/user/noticeSystemInfo"/>" method="post">
              <div class="form-inline" style="margin:10px;">
                <div style="float:right">
                <a href="<c:url value="/user/noticeSystemInfoAddView"/>">
              ...
              <tbody>
                  <c:forEach var="notice" items="${result.noticeList }" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <a href="<c:url value="/user/noticeSystemInfoEditView/${notice.noticeId }"/>">编辑</a>
                            <a href="javascript:deleteNoticeSystemInfo(${notice.noticeId });" />删除</a>
                        </td>
                  </tr>
                </c:forEach>
              </tbody>
...
<script type="text/javascript">
  ...
  function deleteNoticeSystemInfo(id) {
    var ret = window.confirm('是否确定删除？');
    if(!ret)
      return false;
    $.ajax({
      url : "${basePath}/user/noticeSystemInfoDelete/" + id,
      type : "POST",
