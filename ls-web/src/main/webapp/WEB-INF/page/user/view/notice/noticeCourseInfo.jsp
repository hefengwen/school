  ...
  <div class="container">
    ...
    <div class="row clearfix allContent">
      <div class="row clearfix" style="height: 100%;">
        ...
        <div class="content">
          <div class="condition">
            <form id="condition" role="form" action="<c:url value="/user/noticeCourseInfo"/>" method="post">
              <div class="form-inline" style="margin:10px;">
                <div style="float:right">
                <a href="<c:url value="/user/noticeCourseInfoAddView"/>">
                  <img src="<c:url value="/image/addnotice.png"/>" /> <b>新增公告</b></a>
                </div>
              ...
              <tbody>
                  <c:forEach var="notice" items="${result.noticeList }" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <a href="<c:url value="/user/noticeCourseInfoEditView/${notice.noticeId }"/>">编辑</a>
                            <a href="javascript:deleteNoticeCourseInfo(${notice.noticeId });" />删除</a>
                        </td>
                  </tr>
                </c:forEach>
              </tbody>
...
<script type="text/javascript">
  ...
  function deleteNoticeCourseInfo(id) {
    var ret = window.confirm('是否确定删除？');
    if(!ret)
      return false;
    $.ajax({
      url : "${basePath}/user/noticeCourseInfoDelete/" + id,
      type : "POST",
