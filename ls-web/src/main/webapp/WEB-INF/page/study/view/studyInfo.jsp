  ...
  <div class="container">
    ...
    <div class="row clearfix allContent">
      <div class="row clearfix" style="height: 100%;">
        ...
        <div class="content">
          <div class="condition">
            <form id="condition" role="form" action="<c:url value="/study/studyInfo"/>" method="post">
          ...
          <div class="condition">
            <div class="form-inline">
                <a href="javascript:changeCourseType('');"><span id="typeAll" class="menu type">全部</span>
                <c:forEach var="t" items="${courseTypes}">
                    <a href="javascript:changeCourseType('${t.dictId }');"><span id="type${t.dictId }" class="menu type">${t.name }</span></a>
                </c:forEach>
