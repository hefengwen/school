  ...
  <div class="container">
    ...
    <div class="row clearfix allContent">
      ...
      <div class="row clearfix" style="height: 100%;">
        ...
        <div class="content">
          <div class="condition">
            <form id="condition" role="form" action="<c:url value="/user/teacherInfo"/>"
              method="post">
              <div class="form-inline" style="margin: 10px;">
                <div style="float: right">
                  <a href="<c:url value="/user/teacherInfoAddView"/>">
                  <img src="<c:url value="/image/adduser.png"/>" /><b> 新增教师</b></a>
                </div>
              ...
              <tbody>
                <c:forEach var="teacher" items="${result.userList }" varStatus="status">
                  <tr>
                    ...
                    <td><a href="<c:url value="/user/teacherInfoEditView/${teacher.userId }"/>">编辑</a>
                      <a href="javascript:deleteTeacher('${teacher.userId }');" />删除</a></td>
                  </tr>
                </c:forEach>
              </tbody>
            </table>
...
<script type="text/javascript">
	...
	function deleteTeacher(id) {
		...
		if (!ret)
			return false;
		$.ajax({
			url : "${basePath}/user/teacherInfoDelete/" + id,
			type : "POST",
