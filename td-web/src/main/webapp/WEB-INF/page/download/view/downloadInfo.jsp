    ...
    <div class="row clearfix allContent">
      <div class="row clearfix" style="height: 100%;">
        ...
        <div class="content">
          ...
          <div class="condition">
            <div class="form-inline">
                <a href="javascript:changeResourceType('');"><span id="typeAll" class="menu type">全部</span>
                <c:forEach var="r" items="${resourceTypes}">
                    <a href="javascript:changeResourceType('${r.dictId }');"><span id="type${r.dictId }" class="menu type">${r.name }</span></a>
                </c:forEach>
