...
<ul class="list-unstyled leftUl" >
  ...
  <a href="<c:url value="/user/courseInfo"/>" >
    <li id="courseInfo" class="menu leftUlListLi">
      <b class="leftUlListLiFont">课程管理</b>
    </li>
  </a>
  <a href="<c:url value="/user/studentInfo"/>" >
    <li id="studentInfo" class="menu leftUlListLi">
      <b class="leftUlListLiFont">学生管理</b>
    </li>
  </a>
  <a href="<c:url value="/user/resourceInfo"/>" >
    <li id="resourceInfo" class="menu leftUlListLi">
      <b class="leftUlListLiFont">资源管理</b>
    </li>
  </a>
  ...
  <a href="<c:url value="/user/noticeCourseInfo"/>">
    <li id="noticeCourseInfo" class="menu leftUlListLi">
